...
var ApiEndpoint = "https://api.coinbase.com/v2/prices/XTZ-USD/sell";
var job = new CronJob('* * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, amount;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios.get(ApiEndpoint)];
            case 1:
                response = _a.sent();
